...
function Establish_ndim_Globally_1
   ...
   figure()
    %subplot(2,1,1)
    [100*ndim_Dom_Categ/NumParticipants; 100*ndim_NonDom_Categ/NumParticipants]'
    ...
    xlabel('Number of Kinematic Synergies', 'FontSize',12)
    xt = get(gca, 'XTick');
...
% % %     ylabel('DOF VAF: Strong Limb (%)', 'FontSize',12)
% % %     axis([0 DOF+1 25 105])
% % %     xt = get(gca, 'XTick');
...
% % %     ylabel('DOF VAF: Weak Limb (%)', 'FontSize',12)
% % %     axis([0 DOF+1 25 105])
% % %     xt = get(gca, 'XTick');
% % %     set(gca, 'XTick', xt, 'XTickLabel', {'TrRol' 'TrYaw' 'TrPit' ...
% % %         'ShFlEx' 'ShAbAd' 'ShRot' 'ElFlEx' 'ElPrSu' 'WrDev' 'WrFlEx'},'fontsize',10)
